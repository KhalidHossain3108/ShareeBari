...
<hr style="position:fixed" color="840564" size="12">
...
<div class="a2" style="  background-image:url(titem1.jpg) ">
<marquee scrolldelay="200" scrollamount="70" direction="down" behavior="slide">
<center><p style=" font-family: 'CharukolaUltraLight', sans-serif;   color:white; font-size:64px">মানুষ পোশাক দ্বারা অঙ্কিত হয়, <br>আমরা পোশাকে আকিঁ। </p></center>
<br><br><br>
</marquee>
</div>
...
<img class="a7" src="tscroll1.jpeg"  height="800px" width="100%">
...
<div class="content">
<p style="font-family:'Hind Siliguri', sans-serif; ">শাড়ি বাড়ি কাজ করছে শাড়ি নিয়ে প্রায় দুই বছরের অভিজ্ঞতা থেকে । আমরা সুতি, সিল্ক শাড়ি নিয়ে কাজ করছি। ব্লক বাটিক ট্যাসেলসহ আরো বিভিন্ন প্রকারের ডিজাইন শোভা পায় আমাদের শাড়িগুলোতে। ব্যতিক্রম, দৃষ্টিনন্দন, আরামদায়ক, টেকসই পোশাক তৈরী আমাদের মূল লক্ষ্য। </p>
</p> 
...
<p class="a4"> Powered by : <a href="https://m.facebook.com/md.khalidhossain.3108"> <span style="font-family:cursive">Khalid Hossain </span></a></p>
</center> </footer>
</center>
<script>
...
y=y+1;
 if(y%3==0)
  {
  x[1].src="tscroll2.jpeg";
  x[1].alt="First Image";
  }
else if(y%3==1)  
  {
  x[1].src="tscroll3.jpeg";
  x[1].alt="Second Image";
  }
else
  {
  x[1].src="tscroll1.jpeg";
  x[1].alt="Third Image";
  }
